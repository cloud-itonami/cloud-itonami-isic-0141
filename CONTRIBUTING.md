...
**Maturity: `:implemented`** — `src/cattleops/` implements the reference
CattleOpsAdvisor / RanchingOperationsGovernor actor as a synchronous stub
...
jurisdiction/species reference-data expansion in `cattleops.facts`. Open
