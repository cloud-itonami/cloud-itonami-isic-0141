# Operator Quickstart — Cattle-Raising Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0141** (`cloud-itonami-isic-0141`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0141.git
cd cloud-itonami-isic-0141
```
...
- Blueprint governor key: `ranching-operations-governor`
- Likely source path: `cattleops.governor.cljc`
